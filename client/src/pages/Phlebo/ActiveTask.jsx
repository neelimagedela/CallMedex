...
const getBranchName = (booking) => {
  return (
    booking?.branch ||
    booking?.clinicBranch ||
    booking?.clinic_branch ||
    booking?.deliveryBranch ||
    booking?.delivery_branch ||
    ""
  );
};
...
const ActiveTask = () => {
  ...
  const handleNextStep = async () => {
    ...
    try {
      ...
      if (currentStep === 5) {
        ...
        setCompletedTasks([completedBooking, ...(completedTasks || [])]);

        alert("Collection completed successfully.");
        setPage("phlebo-completed");
      }
    } catch (error) {
      console.error("Collection step error:", error);
  ...
  if (loading) {
    return (
      <div style={{ padding: "32px" }}>
        <h2>Loading active collection...</h2>
      </div>
    );
  }
    ...
    return (
      ...
      >
        ...
        <p style={{ color: "#64748b" }}>
          You do not have any accepted collection right now.
        </p>
  ...
  return (
    <div style={{ maxWidth: "980px", margin: "0 auto" }}>
              ...
              <div
                ...
                style={{
                  ...
                  background: active
                    ...
                    ? "#ecfdf5"
                    : "#f8fafc",
                  color: active || completed ? "#0f766e" : "#64748b",
                  fontWeight: "800",
                  fontSize: "14px",
                }}
              >
      ...
      >
        <h2 style={{ marginTop: 0, marginBottom: "12px", color: "#0f172a" }}>
          Patient Details
        </h2>
        ...
        <div style={{ fontSize: "18px", lineHeight: 1.55, color: "#0f172a" }}>
          ...
          <p style={{ margin: "8px 0 0" }}>
            <strong>Deliver Sample To Branch:</strong>{" "}
            {branchName || "Branch not assigned"}
          </p>
      ...
      {currentStep >= 5 && (
        ...
        >
          <CheckCircle size={16} />
          Ready to complete collection after submitting to lab.
        </p>
      )}
    </div>
  );
